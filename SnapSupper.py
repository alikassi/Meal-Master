...
def upload_file_to_s3(image_path, aws_access_key_id, aws_secret_access_key):
    """
    Uploads a file to an S3 bucket using dynamically input AWS credentials.

    Args:
        image_path (io.BytesIO): BytesIO object containing the image to upload
